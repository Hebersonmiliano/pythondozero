...
export async function POST(request:Request){
 ...
 await sql`INSERT INTO progress (student_id,lesson_slug,answer,completed,updated_at) VALUES (${studentId},${lessonSlug},${answer},${completed},now())
 ...
 const stage=String(body.stage||student.current_stage).slice(0,30);
