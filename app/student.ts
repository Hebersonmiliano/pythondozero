...
export type Progress = { lessonSlug:string; answer:string; codeDraft:string; completed:boolean; reviewStatus:string; teacherFeedback:string; submittedAt:string|null };
